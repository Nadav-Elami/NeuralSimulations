...
WEXAC_PATH = "/home/labs/ulanovsky/nadave/ISY/results_bbin_0.25_r1_r2_pab_ac_1"
...
def create_all_plots(file_path, x_axis, y_axis):
    ...
    create_heatmap(b_win, x_axis, y_axis, B_WIN,WEXAC_PATH)
    create_heatmap(c_win, x_axis, y_axis, C_WIN,WEXAC_PATH)
    create_heatmap(no_fire, x_axis, y_axis, NO_FIRE,WEXAC_PATH)
    create_heatmap(both_fire, x_axis, y_axis, BOTH_FIRE, WEXAC_PATH)
    create_heatmap((b_win+c_win), x_axis, y_axis, "One Fire", WEXAC_PATH)
    ...
    create_rgb_plot(c_win, b_win, no_fire, "R=C win, G=B win, B=No fire", x_axis, y_axis, WEXAC_PATH)


create_all_plots(ALL_RESULTS_FN, "r_cin", "r_bin")